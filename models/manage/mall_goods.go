...
type MallGoodsInfo struct {
	...
	GoodsRank          int             `json:"goodsRank" form:"goodsRank" gorm:"column:goods_rank;comment:商品推荐值;type:int"`
	...
	CreateTime         int64           `json:"createTime" form:"createTime" gorm:"column:create_time;comment:商品添加时间"`
	UpdateUser         int             `json:"updateUser" form:"updateUser" gorm:"column:update_user;comment:修改者主键id;type:int"`
	UpdateTime         int64           `json:"updateTime" form:"updateTime" gorm:"column:update_time;comment:商品修改时间"`
}
