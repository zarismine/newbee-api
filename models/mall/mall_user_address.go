...
type MallUserAddress struct {
	...
	CreateTime    int64           `json:"createTime" form:"createTime" gorm:"column:create_time;comment:添加时间;type:bigint"`
	UpdateTime    int64           `json:"updateTime" form:"updateTime" gorm:"column:update_time;comment:修改时间;type:bigint"`
}
