...
type MallMessage struct {
	MessageId     int               `json:"messageId" form:"messageId" gorm:"primarykey;AUTO_INCREMENT"`
	...
	MessageStatus int               `json:"messageStatus" form:"messageStatus" gorm:"column:message_status;comment:消息状态(0-已读 1-未读);type:tinyint"`
